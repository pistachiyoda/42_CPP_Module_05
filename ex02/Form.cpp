...
Form::Form() : name_("Anonymous"), isSigned_(false), requiredGradeForSign_(lowestGrade_), requiredGradeForExec_(lowestGrade_), target_("Anonymous")
{
...
Form::Form(
    const std::string &name, const int &gradeForSign, const int &gradeForExec, const std::string &target
) : name_(name), isSigned_(false), requiredGradeForSign_(gradeForSign), requiredGradeForExec_(gradeForExec), target_(target)
{
...
Form::Form(
    const Form &form
) : name_(form.name_), requiredGradeForSign_(form.requiredGradeForSign_), requiredGradeForExec_(form.requiredGradeForExec_), target_(form.target_)
{
...
Form::FormIsNotSigned::FormIsNotSigned(const std::string &msg) : std::runtime_error(msg) {}
